...
::: {.fragment .fade-up}
- En un ambiente laboral no existe eso de "estoy haciendo una exploración y ya". Todo código que es finalmente **útil** termina en **producción** y **nunca**
se trabaja solo. Por lo tanto, es muy importante cuidar la forma en que programamos.
:::
